...
public:
	...
	void moveForward(int M1speed, int M2speed);		// Hàm chạy thẳng về phía bbb trước với tham số động cơ 1 và 2 tùy chỉnh
	...
	void setServo1(int Angle);		// Hàm set góc servo 1
	void setServo2(int Angle);		// Hàm set góc servo 2
